                ...
                <div class="contenedor-background">
                    <div class="container">
                        ...
                        <div class="row description-desktop">
                            <div class="col-md-12">
                                <p class="text-center mt-3" style="color: #686868;">{l s='text-pet-resume' mod='profileadv'}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <form method="post" action="{$profileadvajax_profile_url nofilter}" enctype="multipart/form-data"
                        ...
                        <section data-step='3' class="data-step" style="display: none;">
                            ...
                            <div class="text-center">
                                ...
                                <div class="row select-button">
                                    <p class="input-title fw-700 black">{l s='...' mod='profileadv'}</p>
                                ...
                                <div class="row">
                                    <p class="input-title fw-700 black select-genre"> {l s='Breed is' mod='profileadv'}</p>
                                ...
                                <div class="row">
                                    <p class="input-title fw-700 black"> {l s='pet characteristic' mod='profileadv'}</p>
                            ...
                            <div class="text-center mt-3" style="padding: 0% 20%;">
                                ...
                                <div class="row" style="padding: 0 20%;">
                                    <p class="input-title fw-700"> {l s='Desired Weight pre' mod='profileadv'} <span
                                            class="pet-name-span"></span>{l s='Desired weight post' mod='profileadv'} (kg)</p>
                        ...
                        <section data-step='5' class="data-step" style="display: none;">
                            ...
                            <div class="text-center mt-3">
                                <div class="row">
                                    <p class="input-title fw-600 black">
                            ...
                            <div class="text-center">
                                <div>
                                    <div class="enable-option-button">
                                        <p class="input-title fw-700" style="font-size: 20px;">{l s='¿' mod='profileadv'}
                                ...
                                <div>
                                    <div class="enable-option-button mt-5">
                                        <p class="input-title fw-700" style="font-size: 20px;">
                                                ...
                                                <dl class="b-photo-ed">
                                                    ...
                                                    <dd class="text-center">
                                                        ...
                                                        <div class="alert alert-info">
                                                            {l s='Formatos permitidos' mod='profileadv'} *.png;
                                                            *.jpeg;
                        ...
                        <section data-step='8' class="data-step" style="display: none;">
                            <div class="profileadv-add-header">
                                <h1>
                                    <span class="fw-500">{l s='Step8-title-pre' mod='profileadv'}</span>
                                    <span class="fw-700">{l s='Step8-title-post' mod='profileadv'}</span>
                                </h1>
                                <p class="fw-500 black mt-2">{l s='Step8-subtitle' mod='profileadv'}</p>
                            </div>
                            <div class="text-center mt-2" style="margin: 5% 0% 3% 0% !important">
                                <div class="row">
                                    <div class="row enable-option-button">
                                        <p class="input-title fw-700" style="font-size: 20px;">
                                            {l s='Registro1' mod='profileadv'}<span
                                                class="pet-name-span"></span>{l s='Registro2' mod='profileadv'}
                                        </p>
                                    </div>
                                    <input type="email" class="form-control" id="inputEmail" name="pet-customer-email" required>
                                </div>
                            </div>
                            <div class="row">
                                <center>
                                    <p>{l s='terms' mod='profileadv'}<a href="{$link->getCMSLink(2)}"
                                            target="_blank">{l s='termslink1' mod='profileadv'}</a>{l s='and' mod='profileadv'}<a
                                            href="{$link->getCMSLink(15)}"
                                            target="_blank">{l s='termslink2' mod='profileadv'}</a>{l s='terms2' mod='profileadv'}
                                    </p>
                                </center>
                            </div>
                            <div class="navigation-buttons mt-2">
                                <button type="button" class="btn previous"
                                    data-step='6'>{l s='Previous' mod='profileadv'}</button>
                                <button type="button" class="btn next" id="submit-button"
                                    onclick="validateStep(8)">Finalizar</a>
                            </div>
                        </section>
                    </form>
                </div>
