...
{if $profileadvpadv_left == 1}

<div id="profileadv_block_left"  class="block {if $profileadvis17 == 1}padding-17 block-categories hidden-sm-down{/if} {if $profileadvis16 == 1}blockmanufacturer16{else}blockmanufacturer{/if}" >
